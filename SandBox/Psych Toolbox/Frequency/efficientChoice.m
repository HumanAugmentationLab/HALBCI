function [  ] = efficientChoice(  window,windowRect,Hz,Hz2,time,extraImage,outlet,mrk)
...
%   Detailed explanation goes here
    ...
    dstRect = CenterRectOnPointd(dstRectOG, xCenter * .5, yCenter);
    ...
    while p<numTimes && ~KbCheck
        ...
        Screen('DrawTexture', window, checkerTexture(textureCue2(1)),[],dstRect2, 0, filterMode);
        Screen('DrawTexture', window, extraImage);
