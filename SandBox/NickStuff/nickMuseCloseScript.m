...
myapproach = {'SpecCSP' 'SignalProcessing',{'EpochExtraction',[0,2],'FIRFilter',[6 12 16 32],'ChannelSelection',{{'TP9' 'FP1' 'FP2' 'TP10'}}}, 'Prediction',{'FeatureExtraction',{'PatternPairs',2},'MachineLearning',{'learner','lda'}}};
...
[trainloss,mymodel,laststats] = bci_train('Data',{mytempdata mytempdata2 mytempdata3},'Approach',myapproach,'TargetMarkers',{'Monkey','Tool'},'EvaluationMetric', 'mse'); 
