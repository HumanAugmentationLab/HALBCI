...
logBool = 0;                        % 1: Write trial data to text file
surveyBool = 1;                     % 0: Trials only | 1: Attention Survey
movieBool = 1;                      % 0: Checkerboard only | 1: checkerboard and movie

% Background Display
WindowCoords = [0 0 400 200];                  % Size of display: [x1, y1, x2, y2] or [] for full screen
...
mCondition1 = 3;                    % Attend CHECK & LOW frequency
mCondition2 = 3;                    % Attend CHECK & HIGH frequency
mCondition3 = 3;                    % Attend STRONG VID & LOW frequency
mCondition4 = 3;                    % Attend STRONG VID & HIGH frequency
mCondition5 = 3;                    % Attend SUBTLE VID & LOW frequency
mCondition6 = 3;                    % Attend SUBTLE VID & HIGH frequency
